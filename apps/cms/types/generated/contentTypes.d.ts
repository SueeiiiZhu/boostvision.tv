...
export interface ApiAppApp extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    appStoreRating: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    appStoreRatingCount: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    googlePlayRating: Schema.Attribute.Decimal &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    googlePlayRatingCount: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    ratingCount: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    ratingSyncedAt: Schema.Attribute.DateTime &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    relatedApps: Schema.Attribute.Relation<'manyToMany', 'api::app.app'>;
...
export interface ApiDeviceBrandDeviceBrand extends Struct.CollectionTypeSchema {
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    source: Schema.Attribute.Enumeration<
      ['app-store', 'google-play', 'website', 'other']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::device-brand.device-brand': ApiDeviceBrandDeviceBrand;
